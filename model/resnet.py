...
class Resnet50_face_sfew_dag(nn.Module):
    ...
    def forward(self, data):
        ...
        conv2_1_sum = torch.add(conv1_adapted_bn, conv2_1c_bn)
        ...
        conv2_2_sum = torch.add(conv2_1, conv2_2c_bn)
        ...
        conv2_3_sum = torch.add(conv2_2, conv2_3c_bn)
        ...
        conv3_1_sum = torch.add(conv2_3_adapted_bn, conv3_1c_bn)
        ...
        conv3_2_sum = torch.add(conv3_1, conv3_2c_bn)
        ...
        conv3_3_sum = torch.add(conv3_2, conv3_3c_bn)
        ...
        conv3_4_sum = torch.add(conv3_3, conv3_4c_bn)
        ...
        conv4_1_sum = torch.add(conv3_4_adapted_bn, conv4_1c_bn)
        ...
        conv4_2_sum = torch.add(conv4_1, conv4_2c_bn)
        ...
        conv4_3_sum = torch.add(conv4_2, conv4_3c_bn)
        ...
        conv4_4_sum = torch.add(conv4_3, conv4_4c_bn)
        ...
        conv4_5_sum = torch.add(conv4_4, conv4_5c_bn)
        ...
        conv4_6_sum = torch.add(conv4_5, conv4_6c_bn)
        ...
        conv5_1_sum = torch.add(conv4_6_adapted_bn, conv5_1c_bn)
        ...
        conv5_2_sum = torch.add(conv5_1, conv5_2c_bn)
        ...
        conv5_3_sum = torch.add(conv5_2, conv5_3c_bn)
        conv5_3 = self.conv5_3_relu(conv5_3_sum)

        b,c,h,w = conv5_3.shape
        x = conv5_3.view(b,c,-1).permute(0,2,1)
