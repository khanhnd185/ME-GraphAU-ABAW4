...
# Datasets
parser.add_argument('--dataset', default="SAW2", type=str, help="experiment dataset BP4D / DISFA / SAW2")
...
# Network and Loss
parser.add_argument('--arc', default='swin_transformer_base', type=str, choices=['resnet18', 'resnet50', 'resnet101', 'resnetvgg',
